...
public partial class CatheterPopup : Popup
{
    ...
    private void CheckCatheterAppointment(object sender, EventArgs e)
    {
        if (BindingContext is Catheter catheter) Check?.Invoke(this, catheter);
        Close();
    }

    private void UpdateCatheterAppointment(object sender, EventArgs e)
    {
        if (BindingContext is Catheter catheter) Update?.Invoke(this, catheter);
        Close();
    }

    private void CallCatheter(object sender, EventArgs e)
    {
